...
- In Group Near, the mean of the IQ is `r round(mean(lead_IQ$IQ[lead_IQ$Smelter == "Near"]), digits = 2)`;
- In Group Far, the mean of the IQ is `r round(mean(lead_IQ$IQ[lead_IQ$Smelter == "Far"]), digits = 2)`.
